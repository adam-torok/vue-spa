...
<div>
    ...
    <div class="p-4">
        ...
        <div class="space-y-1 justify-center w-full mt-3 ml-3">
            <!-- User basic-->
            <div>
                <h2 class="text-xl dark:text-white leading-6 font-bold text-gray">{{currentUser.full_name}}</h2>
                <p class="text-sm dark:text-white leading-5 font-medium text-gray-600">@{{currentUser.username}}</p>
            </div>
            <!-- Description and others -->
            <div class="mt-3">

                <div class="text-gray-600 flex">
                    <label for="bio" class="dark:text-gray-400 font-bold mr-2"><i class="fas fa-feather-alt"></i> Bio:</label>
                ...
                <div class="text-gray-600 flex">
                    <label for="public_email" class="dark:text-gray-400 font-bold mr-2"><i class="fas fa-at"></i> Public email:</label>
                ...
                <div class="text-gray-600 flex">
                    <label for="city" class="dark:text-gray-400 font-bold mr-2"><i class="fas fa-city"></i> City:</label>
                ...
                <div class="text-gray-600 flex">
                    <label for="web" class="dark:text-gray-400 font-bold mr-2"><i class="fas fa-columns"></i> Web:</label>
