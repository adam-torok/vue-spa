        ...
        <div class="flex mr-4 items-center">
          ...
          <div class="block relative">
            ...
            <div class="flex mr-4 items-center">
                ...
                <template v-else>
                    <router-link to="/customers" class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative">Customers</router-link>
                        <a id="navbarDropdown" class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative" href="#" role="button" data-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                           <span class="caret"></span>
                        </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a href="#!" @click.prevent="logout" class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full relative">Logout</a>
                    </div>
                </template>
        </div>
      </div>
