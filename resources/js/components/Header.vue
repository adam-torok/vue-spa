    ...
    <div class="flex-initial">
        <div class="flex justify-end items-center relative">
            <div class="flex md:mr-2 items-center">
                ...
                <template v-else>
                    <router-link data-v-step="2" to="/adverts" class="inline-block dark:text-white dark:hover:text-black py-2 px-3 hover:bg-gray-200 rounded-full relative">Adverts</router-link>
                    <router-link to="/adverts" class="inline-block dark:text-white dark:hover:text-black py-2 px-3 hover:bg-gray-200 rounded-full relative"><i class="fas fa-bell fa-lg"></i></router-link>
                    <router-link to="/adverts" class="inline-block dark:text-white dark:hover:text-black py-2 px-3 hover:bg-gray-200 rounded-full relative"><i class="far fa-comment fa-lg"></i></router-link>
                    ...
                    <transition name="slide">
                        <div v-show="menuOpen" class="dropdown-menu z-30" aria-labelledby="navbarDropdown">
                            ...
                            <router-link to="/profile" class="inline dark:text-white dark:hover:text-black flex justify-center items-center py-2 px-3 hover:bg-gray-200 rounded-full relative">
                            ...
                            <router-link to="/settings" class="inline dark:text-white dark:hover:text-black flex justify-center items-center py-2 px-3 hover:bg-gray-200 rounded-full relative">
                                <i class="fas fa-cog mr-2"></i> Settings
                            </router-link> 
                            <router-link to="/report" class="inline dark:text-white dark:hover:text-black flex justify-center items-center py-2 px-3 hover:bg-gray-200 rounded-full relative">
                                <i class="fas fa-flag mr-2"></i>Reports
                            </router-link> 
                            <router-link to="/privacy-policy" class="inline dark:text-white dark:hover:text-black flex justify-center items-center py-2 px-3 hover:bg-gray-200 rounded-full relative">
                                <i class="fas fa-user-secret mr-2"></i> Privacy Policy
                            </router-link>
                            <a @click="menuOpen = false"  href="#!" @click.prevent="logout" class="inline-block dark:text-white dark:hover:text-black py-2 px-3 hover:bg-gray-200 rounded-full relative">
