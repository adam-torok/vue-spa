...
<nav ref="dropdownMenu" class="naver dark:bg-gray-900 bg-white w-full flex relative justify-between items-center px-2 md:px-2 lg:px4 h-20">
    <div class="inline-flex" data-v-step="1" id='logo'>
        ...
        class="fill-current m-2 text-black dark:text-white" to="/"><div class="hidden md:block">
                    ...
                    <transition name="slide">
                        <div v-show="menuOpen" class="dropdown-menu z-30" aria-labelledby="navbarDropdown">
                            <div @click="menuOpen = !menuOpen" class="dropdpown__inner dark:bg-gray-900">
                                ...
                                <router-link 
                                    to="/report" 
                                    class="inline dark:text-white dark:hover:text-black justify-center items-center py-2 px-3 hover:bg-gray-200 rounded-full relative">
