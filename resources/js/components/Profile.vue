...
<div>
    ...
    <div class="p-4">
        ...
        <div class="space-y-1 justify-center w-full mt-3 ml-3">
            <!-- User basic-->
            <div>
                <h2 class="text-xl leading-6 font-bold text-gray">{{currentUser.name}}</h2>
                <p class="text-sm leading-5 font-medium text-gray-600">@Woltery99</p>
            </div>
            <!-- Description and others -->
            <div class="mt-3">
                <p class="text-gray leading-tight mb-2">Software Engineer / Designer / Entrepreneur <br>Selling things, just for fun.</b> </p>
