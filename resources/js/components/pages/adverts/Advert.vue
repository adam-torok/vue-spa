<template>
  ...
  >
    <div
      class="flex flex-col items-stretch min-h-full pb-4 mb-3 transition-all duration-150 bg-white rounded-lg shadow-lg hover:shadow-2xl"
    >
      ...
      <section class="px-4 py-2 mt-2">
        <div class="flex items-center justify-between">
          <div class="flex items-center flex-1">
            ...
            <button  type="submit" class="transition duration-200 bg-gray-500 hover:bg-gray-600 focus:bg-gray-700 focus:shadow-sm focus:ring-4 focus:ring-gray-500 focus:ring-opacity-50 text-white p-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
